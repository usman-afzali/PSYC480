...
-   Brand: Ant Neuro EEGO Sports (EEGO Sports 32 (ES-230) **OR** EEGO Sports 32 pro (ES-231)
-   Amplifier: 32-channel EEGO amplifier, 2 kHz, CE Class IIa medical device
-   Reference: online referencing with **XYZ**
-   Resolution: 24-bit
...
![MATLAB user interface](/figs/matlab.png)
...
![MATLAB preferences](/figs/matlab-pref.png){#fig-matlab}
